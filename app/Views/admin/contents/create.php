...
<body>
    ...
    <div class="container">
        ...
        <div class="form-card">
            <form method="POST" action="/admin/contents/create">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" required placeholder="페이지 제목">
                </div>

                <div class="form-group">
                    <label for="content">내용</label>
                    <textarea id="content" name="content" placeholder="페이지 내용 (HTML 사용 가능)"></textarea>
                ...
                <div class="btn-group">
                    <button type="submit" class="btn">컨텐츠 추가</button>
